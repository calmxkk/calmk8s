...
type RegisterReq struct {
	g.Meta `path:"/register" method:"post" tags:"后台基础" summary:"账号注册"`
	input.RegisterInp
}
...
type LoginCaptchaReq struct {
	g.Meta `path:"/captcha" method:"get" tags:"后台基础" summary:"获取登录验证码"`
}
...
type AccountLoginReq struct {
	g.Meta `path:"/accountLogin" method:"post" tags:"后台基础" summary:"账号登录"`
...
type LoginLogoutReq struct {
	g.Meta `path:"/logout" method:"post" tags:"后台基础" summary:"注销登录"`
}
